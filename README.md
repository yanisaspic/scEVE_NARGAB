...
___
The repository includes the codes used to generate the datasets and the results in the related paper: \
Yanis Asloudj, Fleur Mougin, Patricia Thébault, scEVE: a single-cell RNA-seq ensemble clustering algorithm capitalizing on the differences of predictions between multiple clustering methods, NAR Genomics and Bioinformatics, Volume 7, Issue 2, June 2025, lqaf073, https://doi.org/10.1093/nargab/lqaf073
